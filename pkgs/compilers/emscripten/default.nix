...
stdenv.mkDerivation rec {
  ...
  llvmEnv = symlinkJoin {
    ...
    paths = with llvmPackages_12; [ clang-unwrapped clang-unwrapped.lib lld llvm ];
  };
  ...
  src = fetchFromGitHub {
    ...
    repo = "emscripten";
    sha256 = "sha256-fvXSc2tY9rg2TuN3rGixYVH2dRRdNNO3X4M3bRXm8T4=";
    rev = version;
  };
  ...
  patches = [
    (substituteAll {
      ...
      resourceDir = "${llvmEnv}/lib/clang/12/";
    })
  ];
