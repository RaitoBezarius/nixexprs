...
let
  ...
  # b should be after a iff b extends clause is not a's name
  # e.g.
  # privset "hello" { ... }
  ...
  orderedPrivsets = toposort (a: b: a.key != b.value.extends) (mapAttrsToList nameValuePair cfg.settings.privset);
  configContents = ''
    # Generated by Nix
    /* Extensions */
