...
self: super: {
  ...
  nixops = super.nixops.overridePythonAttrs (
    _: {
      src = pkgs.fetchgit {
        ...
        sha256 = "03f272v6vrvsk5vp9cfqqsd08kd71q974y3fcfkkl807lpjcrm1j";
      };
    }
  );
  ...
  nixops-proxmox = super.nixops-proxmox.overridePythonAttrs (
    _: {
      src = pkgs.fetchgit {
        url = "https://github.com/RaitoBezarius/nixops-proxmox.git";
        rev = "d69e7f1234fa98f8d1b3c0cc6100f26db380af6c";
        sha256 = "15ksqdi12y0l02isqpdfr2iy9ixblvd4j7p47s301lirljrc8rbp";
      };
    }
  );
